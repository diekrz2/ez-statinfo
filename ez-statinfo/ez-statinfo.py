...
# The space between statistics can be adjusted
    text = (
            ...
            f"SSD: {disk.used // 1024**3}GB / {disk.total // 1024**3}GB"
            )
...
# Button
button = tk.Button(root, text="x", fg="white", bg="black",
                   relief="solid", bd=2, width=1, command=close_app)
button.pack(side='bottom')

# Drag Bar
drag_bar = tk.Canvas(root, bg="black", highlightthickness=0,
                     height=10, width=450)
